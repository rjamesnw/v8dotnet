...
namespace V8.Net
{
    ...
    public unsafe interface INativeHandleBased
    {
        HandleProxy* GetNativeHandleProxy();
    }
    ...
    public static unsafe class Utilities
    {
        ...
        /// </summary>
        public static HandleProxy** MakeHandleProxyArray<T>(T[] items) where T : INativeHandleBased
        {
            ...
            for (var i = 0; i < items.Length; i++)
                nativeArrayMem[i] = items[i].GetNativeHandleProxy();
